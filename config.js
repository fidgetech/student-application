...
export const intendOptions = ['Website and Mobile App Development Full-time', 'Website and Mobile App Development Part-time (morning 9am - 12pm PT)', 'Website and Mobile App Development Part-time (afternoon 1pm - 4pm PT)', 'Digital Design Full-time only', 'Videography Full-time only'];
...
export const startdateOptions = ['January 3, 2025'];
